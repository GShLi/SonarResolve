...
class Config:
    ...
    JIRA_INCLUDE_CODE_SNIPPET = os.getenv('JIRA_INCLUDE_CODE_SNIPPET', 'true').lower() == 'true'
    ...
    LOG_FILE_PATH = os.getenv('LOG_FILE_PATH', os.path.join(_project_root, 'logs', 'sonar_resolve.log'))
    ...
    DATABASE_PATH = os.getenv('DATABASE_PATH', os.path.join(_project_root, 'db', 'project_status.db'))
